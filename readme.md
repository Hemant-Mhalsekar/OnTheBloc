...
it's my personal daily timetable. that's it. nothing fancy. i made it because i kept losing track of my schedule and also kept convincing myself that "i'll just quickly check one youtube video" and then it's suddenly 4pm.
...
- shows my daily schedule in 3 modes depending on how i'm feeling
...
## why i built this instead of just using google calendar

google calendar doesn't have a dark theme that makes me feel like a hacker. also this has a streak counter and google calendar does not. priorities.
...
2. job applications daily. minimum 2. no excuses. "i'll do double tomorrow" is not real.
...
the grind is active. the distractions are also active. this app is the referee.
